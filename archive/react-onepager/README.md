> **ARCHIVADO — 16/08/2026.**
> Esta era la dirección anterior: one-pager en React/Vite. El sitio ahora es PHP
> plano en la raíz del repo (ver `PLAN.md`). Nada de esta carpeta se despliega.
>
> Sigue siendo útil como referencia: `PENDIENTES.md` (datos por confirmar) y
> `PROMPTS-HIGGSFIELD.md` (prompts de imágenes). Ojo: el número de WhatsApp y el
> email que aparecen en `src/site.ts` nunca se confirmaron, y el portfolio lista
> propia/pozo/gruas como trabajos propios sin verificar.
